...
if (!['pc','xbl','psn'].includes(args[0])) message.channel.send('**Lütfen Platform Seçin**: `+fortnite pc | xbl | psn kullanıcıadı` **Örnek**: `+fortnite pc xLare` ');

if (!args[1]) return message.channel.send('**Lütfen Kullanıcı İsmi Girin**: `+fortnite pc | xbl | psn kullanıcıadı` **Örnek**: `+fortnite pc xLare` ');
